    ...
    return (
      <ModalOverlay>
        <ModalContent>
          ...
          <p>
            Номер заказа: <strong>{successData.orderId}</strong>
          </p>
          <p>
            Сумма:{' '}
            <strong style={{ color: 'rgb(var(--theme-yellow))' }}>{successData.price} руб.</strong>
          </p>
          <div style={{ lineHeight: '25px' }}>
            Вы можете найти игру в разделе{' '}
            <a
              href="/games/my"
              style={{ color: 'rgb(var(--theme-yellow))', textDecoration: 'none' }}
            >
              Мои покупки
            </a>
            .
  ...
  return (
    <ModalOverlay>
      <ModalContent>
        ...
        <div>
          {' '}
          {purchaseDone ? successMessage : `После оплаты ссылка будет доступна в "Мои покупки"`}
        </div>
